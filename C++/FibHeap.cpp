...
class FibHeap
{
    ...
    public:
         ...
         *
         * @param[in] k The key to be inserted into the FibHeap
         */
        ...
        void merge(FibHeap<keytype> &H2)
        {
            ...
            H2.b_free = false;
            H2.p_head_root_list = NULL;
            H2.p_tail_root_list = NULL;
            H2.p_minimum_value  = NULL;
        }
    ...
    private:
        ...
        void copy_fib_heap(const FibHeap &obj_being_copied)
        {
            ...
            // Variable that will store the previous root list node in order to
            ...
            for (int idx = 0; idx < obj_being_copied.length_root_list; idx++)
            {
                ...
                // Recurively creates the binomial tree for this root node
         ...
         *
         * @param[in] y The node in the root list that is going to become the child of x
         * @param[in] x The node that is going to be left in the root list.
         */
        ...
        void consolidate()
        {
            ...
            for (int i = 0; i < length_root_list; i++)
            {
                ...
                // If y is not null then two binomial trees were combined, add parent tree to the array
                if (y != NULL)
                {
                    if (y->key > x->key)
                    {
        ...
        /**
         * Function to recursively traverse a binomial tree in the FibHeap.
         *
